...
<!--                                <td>--><?//=number_format($orderProduct->product->orderPrice($orderProduct->amount)/$orderProduct->amount, 2)?><!-- грн.</td>-->
                                <td><?=number_format($orderProduct->orderPrice, 2)?> грн.</td>
                                <td><?=number_format($orderProduct->orderPrice * $orderProduct->amount, 2)?> грн.</td>
                            </tr>
                            <?php endforeach; ?>
                            ...
                            <tr>
                                ...
                                <td class="m_4680003158654335374price" style="border-top:1px solid #dddddd;"><strong><?=number_format($model->getOrderTotalSum($model->id), 2)?> грн</strong></td>
                            </tr>
                            <tr>
                                <td colspan="5">&nbsp;</td>
                            </tr>
