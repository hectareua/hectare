...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['category_id', 'manufacturer_id', 'currency_id', 'is_in_stock', 'is_new', 'is_over', 'price_specify','is_suspended','under_the_order','is_on_sale', 'status', 'delivery', 'super', 'topsale'], 'integer'],
            [['updated_at'], 'safe'],
            [['name_uk', 'name_ru', 'currency_id', 'price'], 'required'],
            [['description_uk', 'description_ru','ykazatel','opt','opt_uk','opt1','opt_uk1','dv','dv_uk','code1c'], 'string'],
