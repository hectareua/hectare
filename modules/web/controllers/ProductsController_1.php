...
class ProductsController extends Controller
{
    ...
    public function actionView($product_id)
    {
        ...
        return $this->render('view', compact('model', 'categories','country', 'parents', 'lastViewedProducts', 'review', 'reviews', 'norm', 'plants', 'question', 'enquiry'));
    }
