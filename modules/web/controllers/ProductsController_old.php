...
class ProductsController extends Controller
{
    ...
    public function actionView($product_id)
    {
        ...
        if ($review->load(Yii::$app->request->post())){
    		...
    		if ($review->save())
    		{
                $review->trigger(Review::EVENT_ON_CREATE);
                return $this->refresh();
    		}
        }
        ...
        return $this->render('view', compact('model', 'categories','country','complects', 'parents', 'lastViewedProducts', 'review', 'reviews', 'maincharact', 'norm', 'plants', 'question', 'enquiry'));
    }
