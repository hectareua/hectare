...
class ProductsController extends Controller
{
    ...
    public function actionIndex($category_id, $manufacturer_ids="", $filter_ids="")
    {
        ...
        $models = $models->orderBy($sort->orders) //->orderBy('super desc,topsale desc,order asc')
        ...
        return $this->render('index', compact('models', 'category', 'parents', 'pagination', 'categories', 'manufacturers', 'manufacturer_ids',
    ...
    public function actionView($product_id)
    {
        ...
        return $this->render('view', compact('model', 'categories','country','complects', 'parents', 'lastViewedProducts', 'review', 'reviews', 'maincharact', 'norm', 'plants', 'question', 'enquiry', 'manufacter'));
    }
    ...
    public function actionSales($filter = null)
    {
	    ...
	    return $this->render('with_label', compact('models', 'category', 'parents', 'pagination', 'categories', 'manufacturers', 'manufacturer_ids',
		    'pageFilters', 'filter_ids', '_manufacturer_ids', 'page', 'manufacturerDesc', 'manufacturerTitle', 'manufacturerH',
		    'manufacturerKeywords', 'filterDesc', 'filterTitle', 'filterH', 'filterKeywords','filterDescriptionFull', 'manufacturerDescriptionFull','numberPages',
		    'seotitle', 'seoheader', 'seodesc','attrs'));
    }
    ...
    public function replyComments($arr, $model){
        if (is_array($arr)){}
        foreach ($arr as $reply){
            echo $this->renderAjax('reply',compact('reply', 'model'));
            self::replyComments($reply->replies, $model);
        }
    }
}
