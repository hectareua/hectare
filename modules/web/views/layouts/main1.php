        ...
        <header class="header row">
            <div class="header-top">
                <div class="wrapper">
                  ...
                  <!--           <li class="header-top-url-list__item menubrands">
                            ...
                            <li class="header-top-url-list__item menubrands"><a href="<?= Url::to(['default/credits']) ?>"><?= Yii::t('web', 'Кредитование') ?></a></li>
            ...
            <div class="header-mid">
                <div class="wrapper text-center">
                    ...
                    <div class="header-mid-menu-left">
                    ...
                    <div class="header-mid-menu-right">
                        <a href="<?= Url::to(['user/index']) ?>" class="header-mid-menu-right-item header-mid-menu-right-item_sc">
                            ...
                            <div class="header-mid-menu-right-item_text"><?= Yii::t('web', 'Личный') ?> <br> <?= Yii::t('web', 'кабинет') ?></div>
                        </a>
                        <a href="<?= Url::to(['cart/index']) ?>" class="header-mid-menu-right-item header-mid-menu-right-item_ct">
                            <div class="header-mid-menu-right-item_img"><i><?= $this->context->getCartTotalAmount()? : '' ?></i></div>
            ...
            <div class="telephone-xs">
                <span>+38 (096) 733 73 30 </span> <span>+38 (099) 733 73 30</span>
            </div>
            <div class="sandwich-menu">
                <div class="sandwich-menu-layout"></div>
                <ul>
                    <span id="sandwich-close"></span>
                    <li class="sandwich-menu-title"><a href="#"><?= Yii::t('web', 'Меню') ?></a></li>
                    ...
                    <li><a href="<?= Url::to(['default/partners']) ?>"><?= Yii::t('web', 'Партнеры') ?></a></li>
            ...
            <div class="header-bottom">
                <div class="wrapper">
                    ...
                    <div class="header-bottom-searchForm search_form">
        ...
        <footer class="footer row">
            ...
            <div class="wrapper">
                ...
                <div class="footer-products col-lg-2 col-md-6 col-sm-12 col-xs-12 text-left">
					...
					<div class="grafik"><div class="contactspan">Пн-Пт</div> <?= Yii::t('web', 'с') ?> 8.00-20.00</div>
					<div class="grafik"><div class="contactspan">Сб</div> <?= Yii::t('web', 'с') ?> 8.00-20.00</div>
					<div class="grafik"><div class="contactspan"><?= Yii::t('web', 'Вс') ?></div> <?= Yii::t('web', 'с') ?> 8.00-18.00</div>
                </div>
            ...
            <li class="footer-company-list__item"><a href="<?= Url::to(['default/cooperation']) ?>"><?= Yii::t('web', 'Сотрудничество с нами') ?></a></li>
                ...
                <div class="footer-contacts col-lg-3 col-md-4 col-sm-6 col-xs-6 text-left">
                    ...
                    <div class="footer-contacts-list" itemscope itemtype="http://schema.org/Organization">
                        ...
                        <span class="footer-contacts__adress footer-contacts-list__item" itemprop="email"><?= $this->context->siteInfo->contacts_email ?></span>
                    </div>
