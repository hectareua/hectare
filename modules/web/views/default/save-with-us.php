...
$this->title = Yii::t('web', 'Экономьте с нами') . ' | Гектар';
$lang = Yii::$app->language;
if($lang == 'ru') {
    $this->registerMetaTag(['name'=> 'description', 'content' => Yii::t('web', 'Экономьте с нами') . '. Корпорация Гектар: экономьте с нами.']);
} else {
    $this->registerMetaTag(['name'=> 'description', 'content' => Yii::t('web', 'Экономьте с нами') . '. Корпорація Гектар: экономьте с нами.']);
}
...
?>
    ...
    <div>
        <div style="text-align: center; margin:20px 0;">
            ...
            <?php } ?>
            <?php } else { ?>
                    <div class="history__img_sep" style="width: 100%">
                        <?php /* <img class="img-responsible" src="<?=$h->image->url?>" alt="<?=$h->{'name_'.$lang}?>" />   */ ?>
                        <div class="text-center">
                            <h1><?= Yii::t('web', 'Страница обновляется')?></h1>
                        </div>
                    </div>
            <?php } ?>
        </div>
