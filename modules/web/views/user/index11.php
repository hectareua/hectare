...
<div class="cabinet">
    <div class="wrapper">
        ...
        <div class="cabinet__title"><span style="vertical-align: middle"><?=Yii::t('web', 'Личный кабинет')?></span>
            <?php if($client->user_id == 284):?>
                <span><img class="image-user" src=<?= Url::to("@web/images/logo-ukravit-product-agroplant.png")?>  style="vertical-align:middle; margin-left: 20px; max-width:250px; " /></span></div>
            <?php endif;?>
        <div class="tabs cabinet-main">
            <ul class="tabs-control">
             ...
             <?php /*   <li class="tabs-control__item"><a href="" class="tabs-control__item_link"><?=Yii::t('web', 'Заказы')?></a> </li> */ ?>
                <li class="tabs-control__item"><a href="" class="tabs-control__item_link"><?=Yii::t('web', 'Остатки')?></a> </li>
               <?php /*   <li class="tabs-control__item"><a href="" class="tabs-control__item_link"><?=Yii::t('web', 'Архив заказов')?></a> </li> */ ?>
            ...
            <ul class="tabs-list">
              ...
              <?php /*  <li class="tabs-list__item cabinet-main-orders">
