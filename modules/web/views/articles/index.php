...
$this->title = Yii::t('web', 'Статьи') . ' | Гектар';
...
if ($page == 1) {
    ...
    $this->title = Yii::t('web', 'Статьи') . Yii::t('web', 'seo-paging', ['page' => $page]) . ' | Гектар';
}
?>
<div class="wrapper">
...
<!--        <li itemprop="itemListElement" itemscope-->
<!--         itemtype="http://schema.org/ListItem" class="breadcrumbs__item"><span itemprop="name">--><?//=Yii::t('web', 'Статьи')?><!--</span><meta itemprop="position" content="2" /></li>-->
    </ol>
    <div class="news">
        <div class="news-list">
            <?php foreach ($models as $model): ?>
                <?php $url = Url::toArticle($model); ?>
