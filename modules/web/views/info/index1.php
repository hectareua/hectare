...
$this->title = Yii::t('web', 'Гектар INFO');
...
<div class="hectare-info">
    <div class="hectare-info-header">
        <a href="/" class="main-page">
            <span class="glyphicon glyphicon-menu-left"></span><span class="glyphicon glyphicon-menu-left"></span> На головну
        </a>
            ...
            <?php if($tab->id == 1):?>
                <?php foreach ($numbers as $num):?>
                    ...
                    <div class="row">
                        ...
                        <?php  foreach ($tabsContent as $tabContent):?>
                                ...
                                <div class="col-md-4 info-wrapper books">
                                    ...
                                    <?php else: ?>
                                        <?php $i=1; foreach($tabContent->images as $image): ?>
                                            <a data-id="<?=$tabContent->id?>" class="info-img" data-fancybox="gallery" href="<?=$image->url?>" rel="group">
                                                <?php if($i==1):?>
                                                    <img src="<?=$tabContent->image->url?>" alt="Фото випуску" />
                                                <?php endif;?>
                                            </a>
