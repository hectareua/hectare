                ...
                <div class="col-3">
                    <div class="news_box">
                        <a class="b_photo" href="<?=Url::toInfoView($issue)?>">
                            <img src="<?=$issue->imageTwo->url?$issue->imageTwo->url:$issue->image->url?>" class="attachment-thumb-interview size-thumb-interview wp-post-image" alt="">                        <i class="bg"></i>
                            <div class="text_tip">
                ...
                <div class="col-3">
                    <div class="news_box">
                        <a class="b_photo" href="<?=Url::toInfoView($interview)?>">
                            <img src="<?=$interview->imageTwo->url?$interview->imageTwo->url:$interview->image->url?>" class="attachment-thumb-interview size-thumb-interview wp-post-image" alt="">                        <i class="bg"></i>
                            <div class="text_tip">
                    ...
                    <div class="col-4">
                        <div class="news_box">
                            <a class="b_photo" href="<?=Url::toInfoView($reportage)?>">
                                <img src="<?=$reportage->imageTwo->url?$reportage->imageTwo->url:$reportage->image->url?>" class="attachment-thumb-reportages size-thumb-reportages wp-post-image" alt="">                        <i class="bg"></i>
                                <div class="text_tip">
...
<!--                                    <span class="time_icon">5</span>-->
    ...
    <?php if($advertising[1]->text_uk):?>
        <section class="subscribe" style="padding-top: 0; padding-bottom: 0;">
            <div class="subscribe_title"><?=$advertising[1]->text_uk?></div>
        </section>
    <?php endif;?>
                        ...
                        <div class="col-4">
                            <div class="news_box">
                                <a class="b_photo" href="<?=Url::toInfoView($article)?>">
                                    <img src="<?=$article->imageTwo->url?$article->imageTwo->url:$article->image->url?>" class="attachment-thumb-reportages size-thumb-reportages wp-post-image" alt="">                        <i class="bg"></i>
                                    <div class="text_tip">
...
<!--                                        <span class="time_icon">5</span>-->
    ...
    <?php if($advertising[2]->text_uk):?>
        <section class="subscribe" style="padding-top: 0; padding-bottom: 0; margin-bottom: 20px;">
            <div class="subscribe_title"><?=$advertising[2]->text_uk?></div>
        </section>
    <?php endif;?>
                ...
                <div class="col-3">
                    <div class="news_box columns_box">
                        <a class="b_photo" href="<?=Url::toInfoView($item)?>">
                            <img src="<?=$item->imageTwo->url?$item->imageTwo->url:$item->image->url?>" class="attachment-thumb-columns size-thumb-columns wp-post-image" alt="">                        <i class="bg" style="background-color: "></i>
