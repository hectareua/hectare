                    ...
                    <div class="item-main-right">
                        ...
                        <div class="raw type-buy">
                            ...
                            <?php if(Yii::$app->user->identity->ctype == 2):?>
                                <button id="buy-shop" type="button" class="item-main-right__submit" style="background: #f59f08; width:150px; height: 50px;font-size: 12px;line-height: 14px;"><?=Yii::t('web','Зарезервируйте на сайте, заберите в магазине')?></button> <!--Посмотреть остатки на магазинах-->
                            <?php else: ?>
            ...
            <div class="modal-content">
                <div class="shops-header">
                    <div class="shops-header-left">
                        ...
                        <p><?=Yii::t('web','Населенные пункты:')?></p>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 delivery text-left">
                                <div class="row delivery-head">
                                    <div class="col-md-7 col-xs-12 text-left">
                                        <p style="font-size: 20px">Доставка:</p>
                                    </div>
