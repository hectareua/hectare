...
.modal-sertificate .close-modal svg {
  width: 1.75em;
  height: 1.75em;
}
...
.modal-sertificate.active {
  visibility: visible;
  opacity: 1;
  -webkit-transform: scale(1);
          transform: scale(1);
}
.modal-sertificate.active .modal-content {
  opacity: 1;
}
.modal-sertificate.active .close-modal {
            ...
            <div class="item-main">
                ...
                <form id="form" action="<?=Url::to(['cart/add', 'product_id' => $model->id])?>" method="POST">
                    ...
                    <div class="item-main-right">
                        ...
                        <div class="raw">
                            <button id="buy" class="item-main-right__submit" style="width:150px;"><?=Yii::t('web','Купить')?></button>
                            <button id="credit" type="button" class="item-main-right__submit" style="background: #f59f08; width:150px;"><?=Yii::t('web','Купить в кредит')?></button>
                            <!--<button id="buy-shop" type="button" class="item-main-right__submit" style="background: #f59f08; width:150px; height: 50px;font-size: 12px;line-height: 14px;"><?=Yii::t('web','Зарезервируйте на сайте, заберите в магазине')?></button> -->
                        </div>
