...
<?php endif; ?><!--<?=$model->super?>-->
    ...
    <div class="itemsList-desc">
	    <div class="itemsList-item__more itemsList-item-btn text-center"><a href="<?=Url::toProduct($model)?>"><?=Yii::t('web', 'Подробнее')?></a></div>
		<div class="itemsList-item__buy itemsList-item-btn text-center" data-id="<?=$model->id?>"><?=Yii::t('web', 'Купить');?></div>
