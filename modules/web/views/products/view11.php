                ...
                <form id="form" action="<?=Url::to(['cart/add', 'product_id' => $model->id])?>" method="POST">
                    ...
                    <div class="item-main-right">
                        ...
                        <span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
							...
							<?php if (Yii::$app->user->identity->ctype == 4 || Yii::$app->user->identity->ctype == 6): ?>
                        ...
                        <div class="raw type-buy" style="color:white !important;;">
                            ...
                            <?php if(Yii::$app->user->identity->ctype == 3):?>
                                <button id="shop-stocks" type="button" class="item-main-right__submit" style="background: #f59f08; width:100%; height: 50px;font-size: 14px;line-height: 18px;color:white;"><?=Yii::t('web','Посмотреть остатки на магазинах')?></button> <!--Посмотреть остатки на магазинах-->
                            <?php else: ?>
                ...
                <ul class="tabs-list simular-product">
                    ...
                    <li class="tabs-list__item">
                        <ul class="reviews-list">
                            ...
                            <div class="like-value" id="like<?=$_review->id ?>-bs3"><?=$_review->getLikes() ?></div>
                            <i id="dislike<?=$_review->id ?>" data-type="0" data-id="<?=$_review->id ?>" class="glyphicon glyphicon-thumbs-down"></i>
                            <div class="like-value" id="dislike<?=$_review->id ?>-bs3"><?=$_review->getDislikes() ?></div>
                                    </span>
                                    </span>
...
<?php if(Yii::$app->user->identity->ctype != 3 && Yii::$app->user->identity->ctype != 4):?>
                            ...
                            <div class="col-md-6 col-xs-12 text-left select-for-mobile">
                                ...
                                <select class="selectpicker for-partner" data-size="7" data-style="btn-info" data-live-search="true" data-none-results-text="<?=Yii::t('web','Не удалось найти н.п.: ')?>{0}">
                                    ...
                                    <?php foreach ($stocksByShops as $stocksByShop):?>
                                        ...
                                        <option data-availability="<?php if($stocksByShop->franch == 0) echo $stocksByShop->main; else echo $stocksByShop->franch;?>" value="<?= $stocksByShop->stock1c->representative->id?>"><?= $stocksByShop->stock1c->representative->{'address'.$suff}?></option>
                                    <?php endforeach;?>
                                    <?php foreach ($shops as $shop):?>
                        ...
                        <div class="row  shop-availability for-partner" style="margin-left: 0">
                            ...
                            <?php foreach ($stocksByShops as $stocksByShop):?>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <p class="shop-availability-status" data-availability="1">
                                            (<?php if($stocksByShop->franch == 0) echo $stocksByShop->main; else echo $stocksByShop->franch;?>)
                                        </p>
