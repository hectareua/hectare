...
$("#makeOrder").on("click", function() {
   ...
   $("#paymentMethod").val(id);
    ...
    var email = $.trim($("#order-billing_email").val());
...
<div class="order" ng-app>
    <div class="wrapper">
        ...
        <div class="orderForm-sidebar">
            ...
            <?=$form->field($model, 'billing_email')->label(false)->error(false)->input('email', ['class' => 'orderForm-sidebar__input', 'placeholder' => Yii::t('web', 'E-mail').'*', 'required' => ''])?>
