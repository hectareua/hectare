...
<div class="product-form">
    ...
    <?= $form->field($model, 'code1c')->textInput(['label' => 'Код в 1с','placeholder' => 'Код в 1с']) ?>
	...
	<?= $form->field($model, 'is_seeds')->checkbox(['label' => 'Свіже насіння']) ?>
	
	<?= $form->field($model, 'b_friday')->checkbox(['label' => 'Black friday']) ?>
	...
	<?= $form->field($model, 'description_roz')->widget(CKEditor::className(), [
        'options' => ['rows' => 4],
        'preset' => 'full'
    ]) ?>
	...
	<?= $form->field($model, 'discount_one_c')->textInput(['maxlength' => true]) ?>
        ...
        <div class="attribute" id="<?= $measure->attr ? $measure->attr->alias:'none'  ?>">
            <?= $form->field($model, 'attributeValuesData')->widget(MultipleInput::className(), [
                    ...
                    'columns' => [
						...
						[
                            'headerOptions' => ['class' => 'part_price' ],
                            'name'  => 'part_price',
                            'type'  => 'textInput',
                            'title' => 'Ціна партнерська'.($model->ykazatel ? ' за ' . $model->ykazatel: ''),
                            //'options' => ['class' => 'price']
                        ],
                        [
                            ...
                            'options' => ['type' => 'number', 'min' =>'0.000', 'step' => '0.001']
                        ],
                        [
                        ...
                        [
                            ...
                            'type'  => 'dropDownList',
                            'title' => 'Статус',
                            'items' =>  $attributeStatus,
                            'options' => ['id' => 'attributes']
                        ],
                        [
							'headerOptions' => ['class' => 'code1c_attr'],
                            'name'  => 'code1c',
                            'type'  => 'textInput',
                            'title' => 'code1c'
                        ],
						[
							'headerOptions' => ['class' => 'code1c_buh'],
                            'name'  => 'code1c_buh',
                            'type'  => 'textInput',
                            'title' => 'code1c бухг.'
                        ]
